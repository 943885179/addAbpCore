...
import { CreateOrEditPersonComponent } from "@app/persons/create-or-edit-person/create-or-edit-person.component";
import { PhoneNumbersComponent } from './phones/phones.component';
import { CreateOrEditPhoneNumberComponent } from './phones/create-or-edit-phone/create-or-edit-phone.component';
@NgModule({
  imports: [
    CommonModule,
    BrowserModule,
