...
export class PersonServiceProxy {
     ...
     * @return Success
     */
    getPaged(filter: string | null | undefined, sorting: string | null | undefined, maxResultCount: number | null | undefined, skipCount: number | null | undefined): Observable<PagedResultDtoOfPersonListDto> {
     ...
     * @return Success
     */
    getTest(name: string | null | undefined): Observable<string> {
        let url_ = this.baseUrl + "/api/services/app/Person/GetTest?";
        if (name !== undefined)
     ...
     * @return Success
     */
    getPersonListAsync(): Observable<PersonListDto[]> {
        let url_ = this.baseUrl + "/api/services/app/Person/GetPersonListAsync";
        url_ = url_.replace(/[?&]$/, "");
        ...
        return this.http.request("get", url_, options_).pipe(_observableMergeMap((response_: any) => {
            return this.processGetPersonListAsync(response_);
        })).pipe(_observableCatch((response_: any) => {
            if (response_ instanceof HttpResponseBase) {
                try {
                    return this.processGetPersonListAsync(<any>response_);
                } catch (e) {
                    return <Observable<PersonListDto[]>><any>_observableThrow(e);
                }
            } else
    ...
    protected processGetPersonListAsync(response: HttpResponseBase): Observable<PersonListDto[]> {
        const status = response.status;
        const responseBlob =
            response instanceof HttpResponse ? response.body :
                (<any>response).error instanceof Blob ? (<any>response).error : undefined;
...
export class PhoneNumberServiceProxy {
     ...
     * @return Success
     */
    getPaged(filter: string | null | undefined, sorting: string | null | undefined, maxResultCount: number | null | undefined, skipCount: number | null | undefined): Observable<PagedResultDtoOfPhoneNumberListDto> {
