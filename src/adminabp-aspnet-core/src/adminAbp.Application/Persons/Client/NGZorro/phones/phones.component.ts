...
import { CreateOrEditPhoneNumberComponent } from './create-or-edit-phone/create-or-edit-phone.component';
...
export class  PhoneNumbersComponent extends PagedListingComponentBase<PhoneNumberListDto>
	implements OnInit {
